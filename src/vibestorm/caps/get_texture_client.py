...
class GetTextureClient:
    ...
    def _fetch_sync(
        ...
        # no scheme at all -- and that is not GetTextureError.
        require_remote_http_url(url, what="the GetTexture capability", error=GetTextureError)
        ...
        try:
            with open_remote(
                ...
                what="the GetTexture capability",
